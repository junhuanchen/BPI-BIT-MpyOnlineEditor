...
function() {
	...
	*/
	...
	this.DavClient.prototype.PUT = function(path, content, handler, context, locktoken) {
	...
	this.DavClient.prototype.MKCOL = function(path, handler, context, locktoken) {
	...
	this.DavClient.prototype._getRequest = function(method, path, handler, context) {
		/* prepare a request */
	...
	this.getXmlHttpRequest = function() {
		...
		*/
		...
		alert('Your browser does not support XMLHttpRequest, required for ' + 'WebDAV access.');
